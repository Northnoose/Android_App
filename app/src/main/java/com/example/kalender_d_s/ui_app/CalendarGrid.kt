...
fun CalendarGrid(year: Int,
    ...
    Column(modifier = Modifier
        ...
        gridDays.chunked(7).forEach { week -> //Her kaller jeg chunked(7) som deler lista opp i 7 dager
                    ...
                    if (day == null) {
                        ...
                        ElevatedCard(
                            ...
                            colors = CardDefaults.elevatedCardColors
                                (if (isWeekend) MaterialTheme.colorScheme.primaryContainer else MaterialTheme.colorScheme.surface)
                        ) {
                            Text(
                                text = day.dayOfMonth.toString(),
                                modifier = Modifier.padding(8.dp)
                            ) //Gjør om formatet 2025-1-3 til "3"
                        }
                    }
                }
